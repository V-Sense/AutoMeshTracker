...
#include "cpd_transform.h"

namespace cpd {

/// Default value for beta.
const double DEFAULT_BETA = 5.0; //default 3
/// Default value for lambda.
const double DEFAULT_LAMBDA = 5.0; //default 3
...
public:
    ...
    void getAffinity(const Matrix& fixed, const Matrix& moving, Matrix& _aff);
